...
//+kubebuilder:webhook:path=/mutate-apps-liora-io-v1-webapp,mutating=true,failurePolicy=fail,sideEffects=None,groups=apps.liora.io,resources=webapps,verbs=create;update,versions=v1,name=mwebapp.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-apps-liora-io-v1-webapp,mutating=false,failurePolicy=fail,sideEffects=None,groups=apps.liora.io,resources=webapps,verbs=create;update,versions=v1,name=vwebapp.kb.io,admissionReviewVersions=v1
