...
```sh
# In this sample `liora` is the desired namespace
...
```sh
kubectl config set-context $(kubectl config current-context) --namespace=liora
...
*           minikube             minikube         minikube         liora
```
