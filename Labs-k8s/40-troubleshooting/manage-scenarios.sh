...
simulate_and_fix() {
  ...
  kubectl delete -f issue.yaml --ignore-not-found --grace-period=0 --force 2>/dev/null
  kubectl delete -f fix.yaml --ignore-not-found --grace-period=0 --force 2>/dev/null
